"""
Communication Comparison: Baseline vs Discrete Communication
...
This helps agents coordinate and avoid overcrowding.
"""
...
class CommunicationPolicy(nn.Module):
    """Policy that uses communication features."""
...
def main():
    print("="*70)
    print("COMMUNICATION COMPARISON: Baseline vs Discrete")
    print("="*70)
    ...
    comm_metrics = train_communication(True, config, "Discrete_Comm")

    # Create comparison plot
    create_comparison_plot(baseline_metrics, comm_metrics)
